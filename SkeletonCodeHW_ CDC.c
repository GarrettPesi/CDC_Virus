...
/* File to give SEED points - multiples of them
* extended version of CDC infection.
*/
#include   <stdio.h>

//#define DEBUG

float  inf_prob = 0.6;  // prob of making a neighnor infected  

typedef struct nodet { 
	int occupied ;  // is here something ? Yes = 1, no = 0  
	int time_infected; 
	int visited;
